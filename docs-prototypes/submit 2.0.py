...
def token_verif(course):
    ...
    try:
        ...
        try: 
            ...
            print("We are still unable to access your course, please submit manualy, then bring this up with a TA or instructor.")
...
def submit_assignment(files, assign, c, allow_errors = False ):
    ...
    print("you can check your submission here: " + submission.preview_url)
    return True
    ...
    def submit_selected(button):
            ...
            try:
                ...
                if not success and not allow_errors:
                    ...
                    print("We are still unable to submit your assignment, please submit your assignment manualy.")
            except:
